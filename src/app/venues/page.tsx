            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-4xl font-bold">Venue Management</h1>
                                <p className="text-blue-100 mt-1">Manage concert venues and locations</p>
                            </div>
                        </div>
                        <Link href="/">
                            <button className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
                    ...
                    <form action={addVenueAction} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label htmlFor="name" className="block text-lg font-semibold text-gray-700 mb-3">Venue Name *</label>
                            <input
                                type="text"
                                name="name"
                                required
                                className="w-full border-2 border-blue-200 rounded-xl shadow-sm p-4 text-lg text-gray-800 focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 bg-white"
                                placeholder="Enter venue name"
                            />
                        </div>
                        <div>
                            <label htmlFor="address" className="block text-lg font-semibold text-gray-700 mb-3">Address</label>
                            <input
                                type="text"
                                name="address"
                                className="w-full border-2 border-blue-200 rounded-xl shadow-sm p-4 text-lg text-gray-800 focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 bg-white"
                        ...
                        <div>
                            <label htmlFor="capacity" className="block text-lg font-semibold text-gray-700 mb-3">Capacity</label>
                            <input
                                type="number"
                                name="capacity"
                                min="1"
                        ...
                        <div className="md:col-span-3">
                            <button
                                type="submit"
                                className="bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-4 px-8 rounded-xl hover:from-green-600 hover:to-emerald-700 text-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                            >
                                <svg className="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800">All Venues</h2>
                    </div>
                    ...
                    {venues.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-bold text-gray-800 mb-2">No venues yet</h3>
                            <p className="text-gray-600">Add your first venue to get started</p>
                        </div>
                    ) : (
